...
1. [Cloud Basics](#Cloud-Basics)
   ...
   2. [Cloud Deployment Models (Public vs Private vs Hybrid Cloud)](#Cloud-Deployment-Models)
   3. Cloud Computing
   ...
   4. [Cloud Compliance](#Cloud-Compliance)
   5. [Scaling](#Scaling)
2. [Azure Basics](#Azure-Basics)
   1. [Purchasing & Licensing Options](#Purchasing-&-Licensing-Options)
   2. [Account, Subscription, Support and Billing](#Account,-Subscription,-Support-and-Billing)
   3. [Azure Data Centers](#Azure-Data-Centers)
   4. [Interacting with Azure](#Interacting-with-Azure)
   5. [Service-level Agreements (SLA)](Service-level-Agreements-(SLA))
   6. [Azure Resource Manager (Resources & Resource Groups & Management Groups)](#Azure-Resource-Manager-(Resources-&-Resource-Groups-&-Management-Groups))
   7. [Compliance in Azure](#Compliance-in-Azure)
3. [Azure Services](#Azure-Services)
   1. [Compute](#Compute)
      1. [Virtual Machines](#Virtual-Machines)
      2. [Containers](#Containers)
      3. [App Service](#App-Service)
      4. [Serverless Computing](#Serverless-Computing)
   2. [Storage](#Storage)
...
4. Security
   ...
   2. [Defence in Depth](#Defence-in-Depth)
   3. [Azure Security Center](#Azure-Security-Center)
   4. [Identity and Access (Azure AD)](#Identity-and-Access-(Azure AD))
   5. [Encryption (Azure Key Vault, Certificates)](#Encryption-(Azure-Key-Vault,-Certificates))
   6. [Network Protection](#Network-Protection)
   7. [Microsoft Azure Information Protection (AIP)](#Microsoft-Azure-Information-Protection-(AIP))
   8. [Microsoft Defender for Identity](#Microsoft-Defender-for-Identity)
   9. [Microsoft Security Development Lifecycle (SDL)](#Microsoft-Security-Development-Lifecycle-(SDL))
5. Governance
   1. [Azure Policy & Azure Blueprints](#Azure-Policy-&-Azure-Blueprints)
   2. [Monitoring (Azure Monitor & Azure Service Health)](#Monitoring-(Azure-Monitor-&-Azure-Service-Health))
6. Economics
   1. [Economies of Scale](#Economies-of-Scale)
   2. [Capital Expenditure (CapEx) vs Operational Expenditure (OpEx)](#Capital-Expenditure-(CapEx)-vs-Operational-Expenditure-(OpEx))
   3. [Azure Costs & Tools](#Azure-Costs-&-Tools)
   4. [Cost Optimization Best Practices](#Cost-Optimization-Best-Practices)
...
4.7. Microsoft Azure Information Protection (AIP).md
...
5.1. Azure Policy & Azure Blueprints.md
...
5.2. Monitoring (Azure Monitor & Azure Service Health).md
...
6.2. Capital Expenditure (CapEx) vs Operational Expenditure (OpEx).md
...
6.4. Cost Optimization Best Practices.md
